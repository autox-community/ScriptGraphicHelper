...
public class Dmsoft
{
    ...
    public bool Reg()
    {
        ...
        {
            MessageBoxWindow.ShowAsync("错误, 需要在setting.json文件中填写大漠注册码");
            return false;
        }
        ...
        {
            MessageBoxWindow.ShowAsync("注册大漠失败, 返回值: " + result.ToString());
            return false;
        }
    }
    ...
    public Dmsoft()
    {
        ...
        {
            MessageBoxWindow.ShowAsync(e.Message + ", 无法在系统中找到大漠插件!");
        }
