...
namespace ScriptGraphicHelper.Utils.Engine
{
    public class ScriptEngine
    {
        ...
        public void LoadScript(string path)
        {
            ...
            {
                trees.Add(CSharpSyntaxTree.ParseText(File.ReadAllText(path), path: path, encoding: Encoding.UTF8));
            }
        }
        ...
        public EmitResult Compile()
        {
            ...
            if (result.Success)
            {
                ...
                assembly = new WeakReference<Assembly>(alc.LoadFromStream(dll, pdb));
            }
